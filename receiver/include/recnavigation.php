    ...
    <ul class="navbar-nav form-inline my-2 my-lg-0">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item" href="./recindex.php"><i class="fa fa-user" aria-hidden="true"></i> Profile</a>

          <a class="dropdown-item" href="./recupdate.php"><i class="fa fa-edit" aria-hidden="true"></i>
Update Profile</a>
